...
| Function name | Prototype                     | Turn in files                                           | Parameters                           | Return value                                                                           | External functs.   | Description                                                     |
| ------------- | ----------------------------- | ------------------------------------------------------- | ------------------------------------ | -------------------------------------------------------------------------------------- | ------------------ | --------------------------------------------------------------- |
| get_next_line | char \*get_next_line(int fd); | get_next_line.c, get_next_line_utils.c, get_next_line.h | fd: The file descriptor to read from | Read line: correct behavior. NULL: there is nothing else to read, or an error occurred | read, malloc, free | Write a function that returns a line read from afile descriptor |
...
BUFFER_SIZE flag in addition to the usual flags. You can choose the default value of your choice.
```
